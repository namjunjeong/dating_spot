...
function Home() {
    return (
        ...
        <div className="flex-container">
            ...
            <Link to="/Pcroom" style={{marginRight:"2rem"}}><button>PC방</button></Link>
            <Link to="/Place" style={{marginRight:"2rem"}}><button>관광명소</button></Link>
            <Link to="/Restaurant" style={{marginRight:"2rem"}}><button>음식점</button></Link>
            <Link to="/Shopping" style={{marginRight:"2rem"}}><button>쇼핑</button></Link>
